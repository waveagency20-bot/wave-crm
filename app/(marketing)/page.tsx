  ...
  return (
    <main className="min-h-screen bg-[#080E08] text-white overflow-x-hidden font-sans">
      ...
      <section className="relative pt-32 pb-20 px-6">
        ...
        <div className="absolute top-32 left-1/3 w-[250px] h-[250px] bg-[#00FF6A]/4 rounded-full blur-[80px] pointer-events-none" />
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <p className="text-lg md:text-xl text-white/50 max-w-2xl mx-auto mb-10 leading-relaxed">
            ...
            Manage leads, collect M-Pesa payments, and talk to customers on WhatsApp — all in one place.
          </p>
            ...
            <div className="flex">
              ...
              <div className="w-48 border-r border-[#00FF6A]/8 p-4 hidden md:block">
                ...
                {["Dashboard","Contacts","Leads","Pipeline","Tasks","Messages","Campaigns"].map((item, i) => (
                  <div key={item} className={`text-xs px-3 py-2 rounded-lg mb-1 ${i===0 ? 'bg-[#00FF6A]/15 text-[#00FF6A] font-semibold' : 'text-white/30 hover:text-white/60'}`}>
                    {item}
                  </div>
                ))}
              </div>
              ...
              <div className="flex-1 p-5">
                <div className="grid grid-cols-4 gap-3 mb-4">
                  {[
                    {label:"Total Leads",value:"1,284",change:"+12%",c:"text-[#00FF6A]"},
                    {label:"Deals Won",value:"KES 4.2M",change:"+8%",c:"text-[#00FF6A]"},
                    {label:"Open Tasks",value:"47",change:"-3",c:"text-white/40"},
                    {label:"Contacts",value:"892",change:"+34",c:"text-[#00FF6A]"},
                  ].map(s=>(
                    <div key={s.label} className="bg-[#00FF6A]/5 border border-[#00FF6A]/10 rounded-xl p-3">
                      ...
                      <p className={`text-[9px] mt-0.5 ${s.c}`}>{s.change}</p>
                    </div>
                  ))}
                </div>
                <div className="grid grid-cols-3 gap-3">
                  <div className="col-span-2 bg-[#00FF6A]/4 border border-[#00FF6A]/8 rounded-xl p-3">
                    <p className="text-[9px] text-white/35 mb-2">Pipeline overview</p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-white/45 text-lg max-w-xl mx-auto">
              Built for African market realities — mobile-first, M-Pesa native, WhatsApp ready.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-5">
            {[
              {emoji:"👥",color:"rgba(0,255,106,0.1)",border:"rgba(0,255,106,0.2)",tc:"#00FF6A",title:"Lead & Contact Management",desc:"Capture leads from web forms, WhatsApp, and referrals. Score, assign, and track every deal through a visual Kanban pipeline."},
              {emoji:"💬",color:"rgba(0,255,106,0.07)",border:"rgba(0,255,106,0.15)",tc:"#00FF6A",title:"WhatsApp & SMS Campaigns",desc:"Send bulk SMS via Africa's Talking. Connect WhatsApp Business API to message customers directly from the CRM."},
              {emoji:"💳",color:"rgba(0,255,106,0.1)",border:"rgba(0,255,106,0.2)",tc:"#00FF6A",title:"M-Pesa & Stripe Payments",desc:"Collect deposits and invoices via M-Pesa Daraja or Stripe. Payment status syncs automatically to the deal."},
              {emoji:"✅",color:"rgba(0,255,106,0.07)",border:"rgba(0,255,106,0.15)",tc:"#00FF6A",title:"Tasks & Team Collaboration",desc:"Assign follow-up tasks, set reminders, and collaborate in real time with full activity logs."},
              {emoji:"📊",color:"rgba(0,255,106,0.1)",border:"rgba(0,255,106,0.2)",tc:"#00FF6A",title:"Analytics & Reporting",desc:"Track conversion rates, revenue by agent, and campaign ROI. Export reports to Excel or PDF."},
              {emoji:"🔐",color:"rgba(0,255,106,0.07)",border:"rgba(0,255,106,0.15)",tc:"#00FF6A",title:"Role-Based Access Control",desc:"Admin, Manager, and Agent roles. Multi-org support for agencies managing multiple clients."},
            ].map(f=>(
              <div key={f.title} className="rounded-2xl p-6 border transition-all hover:scale-[1.02] group"
                ...
                <h3 className="font-bold text-base mb-2" style={{color:f.tc}}>{f.title}</h3>
      ...
      <section id="pricing" className="py-24 px-6">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-white/45 text-lg mb-14">Priced for Kenyan businesses. Pay in KES via M-Pesa or card.</p>
          <div className="grid md:grid-cols-3 gap-5">
            {[
              {name:"Starter",price:"KES 2,500",per:"/month",desc:"For small businesses just getting started.",features:["Up to 3 users","500 contacts","Basic pipeline","Email support","7-day free trial"],cta:"Start free trial",hot:false},
              {name:"Growth",price:"KES 6,500",per:"/month",desc:"For growing teams that need more power.",features:["Up to 10 users","5,000 contacts","WhatsApp integration","SMS campaigns","M-Pesa payments","Priority support"],cta:"Start free trial",hot:true},
              {name:"Enterprise",price:"Custom",per:"",desc:"For agencies and large organisations.",features:["Unlimited users","Unlimited contacts","Multi-org management","Custom integrations","Dedicated account manager"],cta:"Contact sales",hot:false},
            ].map(p=>(
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-10">
            <div>
              ...
              <p className="text-white/35 text-sm leading-relaxed">The CRM built for African businesses.<br/>Nairobi-based, globally ready.</p>
            </div>
            <div>
